...
module.exports = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      'process.env': isDevelopment ? JSON.stringify(dotenv.config().parsed) : new webpack.EnvironmentPlugin(['API_KEY']),
    }),
    new ESLintPlugin({
      extensions: ['ts', 'tsx'],
      exclude: 'node_modules',
    ...
    new ModuleFederationPlugin({
      ...
      remotes,
      exposes: {
        './Popular': './src/application/components/Popular',
        './Recommendations': './src/application/components/Recommendations',
      },
      shared: [
        {
          ...dependencies,
